...
public class SelectPlaceActivity extends AppCompatActivity implements LocationSource,
    ...
    private void initView() {
        ...
        listView = (ListView) findViewById(R.id.asp_listview);
        searchResultAdapter = new SearchResultAdapter(SelectPlaceActivity.this);
        ...
        searchText = (AutoCompleteTextView) findViewById(R.id.asp_keyWord);
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(SelectPlaceActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(SelectPlaceActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(SelectPlaceActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(SelectPlaceActivity.this, "erroCode " + rCode , Toast.LENGTH_SHORT).show();
            }
        }
    };
