...
public class MHDatabase {
	...
	public static final String MH_FILE = "MH.db";
	...
	public static final String ADS_MH_REFERRER = "ADS_MH_REFERRER";
	public static final String ADS_MH_REGION = "ADS_MH_REGION";
	public static final String MH_GAME_REGION = "MH_GAME_REGION";
	public static final String MH_GOOGLE_ADVERTISING_ID = "MH_GOOGLE_ADVERTISING_ID";
	public static final String MH_FB_LOGIN_ID = "MH_FB_LOGIN_ID";
	public static final String MH_APP_BUSINESS_IDS = "MH_APP_BUSINESS_IDS";
	
	public static final String MH_GAME_DYNAMIC_VERSION_CONTENT = "MH_GAME_DYNAMIC_VERSION_CONTENT";//游戏域名版本号保存的key
	public static final String MH_APP_PLATFORM_DYNAMIC_VERSION_CONTENT = "MH_APP_PLATFORM_DYNAMIC_VERSION_CONTENT";//平台域名版本号保存的key
	
	public static final String MH_LOGIN_USERNAME = "MH_LOGIN_USERNAME";//保存用户的账号
	public static final String MH_LOGIN_PASSWORD = "MH_LOGIN_PASSWORD";//保存用户的密码
	public static final String MH_LOGIN_USER_ID = "MH_LOGIN_USER_ID";//保存用户的用戶id
	public static final String MH_LOGIN_SERVER_RETURN_DATA = "MH_LOGIN_SERVER_RETURN_DATA";//保存服务端返回的数据
	
	public static final String MH_SDK_LANGUAGE = "MH_SDK_LANGUAGE";//SDK设置的语言
	public static final String MH_LOGIN_SIGN = "MH_LOGIN_SIGN";//SDK保存的登陆返回sign
	public static final String MH_LOGIN_TIMESTAMP = "MH_LOGIN_TIMESTAMP";//SDK保存的登陆返回timestamp
