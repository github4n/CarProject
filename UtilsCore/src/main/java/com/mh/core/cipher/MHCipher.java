...
public class MHCipher {
	 ...
	 * DESKEY 默认加密的key
	 */
	private final static String DESKEY = "DESmh////**";
	private final static String DES_SUFFIX = "$|$$***mh";
	 ...
	 * @date 2015年2月5日
	 */
	public static String encryptMHData(String encryptData){
	 ...
	 * @date 2015年2月5日
	 */
	public static String decryptMHData(String decryptData){
	...
	*/
	public static String encryptMHDES(String encryptData){
	...
	* @return 返回原始数据
	*/
	public static String decryptMHDES(String decryptData){
		return decryptDES(decryptData, DESKEY);
	}
	...
	*/
	public static String encryptDES(String encryptData,String cipherKey) {
		...
		try {
			...
			MHLogUtil.logD("mh", "byteResult:" + d);
...
/*    *//**
     ...
     * @return
     *//*
	public static String encryptByAes128(String content, String mhKey) {
		try {
			KeyGenerator kgen = KeyGenerator.getInstance("AES");
			kgen.init(128, new SecureRandom(mhKey.getBytes("utf-8")));
    ...
    *//**解密
     ...
     * @return
     *//*
	public static String decryptByAes128(String content, String mhKey) {
