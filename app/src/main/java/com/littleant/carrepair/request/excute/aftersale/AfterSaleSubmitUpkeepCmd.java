...
public class AfterSaleSubmitUpkeepCmd extends  BaseRequestCmd{
    public AfterSaleSubmitUpkeepCmd(Context context, String id, String content, Bitmap[] pics) {
        super(context);
    ...
    protected String getInterfaceName() {
        return InterfaceConstant.AFTER_SAVE_UPKEEP;
    }
