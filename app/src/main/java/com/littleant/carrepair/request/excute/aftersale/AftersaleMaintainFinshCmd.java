...
public class AftersaleMaintainFinshCmd extends BaseRequestCmd {

    public AftersaleMaintainFinshCmd(Context context, String id) {
        super(context);
    ...
    protected String getInterfaceName() {
        return InterfaceConstant.AFTER_SAVE_MAINTAIN_FINSH;
    }
