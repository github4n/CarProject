...
public class AftersaleReasonActivity extends BaseActivity {
...
//        r_pic_list.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
    ...
    protected int getLayoutId() {
        return R.layout.activity_aftersale_reason;
    }
...
/*        if(requestCode == REQUEST_CODE_CHOOSE && resultCode == RESULT_OK) {
    ...
    private class MyAdapter extends RecyclerView.Adapter<AftersaleReasonActivity.MyAdapter.ViewHolder> {
        ...
        @Override
        public AftersaleReasonActivity.MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_imageview, parent, false);
            AftersaleReasonActivity.MyAdapter.ViewHolder viewHolder = new AftersaleReasonActivity.MyAdapter.ViewHolder(view);
            return viewHolder;
        }
